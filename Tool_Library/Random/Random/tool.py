...
def get_random_number(min:int|str = 0, max:int|str = 65535, cnt:int|str = 1):
    random_value = RandomValues(Mock())
    return random_value.random_number(min,max,cnt)


def get_uuid(cnt:int|str = 1):
    random_value = RandomValues(Mock())
    return random_value.make_uuids(cnt)


def generate_string(len:int|str = 10, cnt:int|str = 1):
    random_value = RandomValues(Mock())
    return random_value.generate_string(len, cnt)


def generate_password(len:int|str = 16, cnt:int|str = 1):
    random_value = RandomValues(Mock())
    return random_value.generate_password(len, cnt)
    

def generate_placeholder_text(cnt:int|str = 1):
    random_value = RandomValues(Mock())
    return random_value.generate_placeholder_text(cnt)
...
if __name__ == '__main__':
    ...
    # print(generate_placeholder_text())
    pass
