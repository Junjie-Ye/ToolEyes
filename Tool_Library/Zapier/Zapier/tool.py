...
def run_zapier_NLA_action(action_id: str, instructions: str, zapier_description: str = "", api_key: str = '', sync: bool = True):
    os.environ['ZAPIER_NLA_API_KEY'] = api_key

    tool = ZapierNLARunAction(
        action_id=action_id, zapier_description=zapier_description)
    if sync == True:
...
def list_zapier_NLA_actions(api_key: str = '', sync: bool = True):
    os.environ['ZAPIER_NLA_API_KEY'] = api_key
...
if __name__ == '__main__':
    print(run_zapier_NLA_action(action_id='01H7YQJ0SAD8C08W2JHPM5SRVN',
          zapier_description="", instructions="Get the latest email from Kaggle."))
