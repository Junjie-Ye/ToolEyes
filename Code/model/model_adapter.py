...
from Code.tool_conversation import Conversation, get_conv_template
from Code.model.compression import load_compress_model
from Code.utils import get_gpu_memory
...
class ToolAdapter(BaseAdapter):
    "Model adapater for tool"

    def match(self, model_path: str):
        return "tool" == model_path
...
class ToolAdapterSingleRound(BaseAdapter):
    "Model adapater for tool-single-round"

    def match(self, model_path: str):
        return "tool-single-round" == model_path
    ...
    def get_default_conv_template(self, model_path: str) -> Conversation:
        return get_conv_template("tool-single-round")


# Note: the registration order matters.
# The one registered earlier has a higher matching priority.
register_model_adapter(ToolAdapter)
register_model_adapter(ToolAdapterSingleRound)
